...
?>
<div class="w-full profile-edit<?php echo $this->pageclass_sfx; ?>">
	...
	<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal well" enctype="multipart/form-data">
			...
			<?php if (count($fields)) : ?>
				<fieldset class="mt-4">
					...
					<?php foreach ($fields as $field) : ?>
						...
						$field->class = 'appearance-none block w-full bg-grey-lighter text-grey-darker border rounded py-3 px-4 mb-6 leading-tight focus:outline-none focus:bg-white';
						?>
						...
						<?php else : ?>
									<?php if (!$field->required && $field->type !== 'Spacer') : ?>
										<span class="optional float-right text-xs">
		...
		<?php endif; ?>
		<div>
			<button class="bg-blue hover:bg-blue-dark text-white font-bold mr-6 py-2 px-4 rounded focus:outline-none focus:shadow-outline validate" type="submit">
